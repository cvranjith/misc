...
/
update sttm_bank set bank_code = '&new_brn';
update sttm_branch set bank_code = (select b.bank_code from sttm_bank b);
...
update sttm_branch set bank_code = '&new_brn'
/
delete eitm_modules_installed where branch_code not in (select branch_Code from sttm_branch);

delete STTM_ACCLS_BRN_RESTR;
delete CSTM_PROD_BRN_DISALLOW;
