...
set termout off
col cntr new_value cntr
select '&1'+1 cntr from dual;
set termout on
cl scr
declare type t is table of varchar2(1000) index by binary_integer; q varchar2(10000) := '&&text'; 
n number := '&cntr';
s varchar2(1); x t; y t;
