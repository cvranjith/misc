...
AND FIN_YEAR||PERIOD_CODE = (SELECT CURRENT_CYCLE||CURRENT_PERIOD FROM STTM_BRANCH WHERE BRANCH_CODE = A.BRANCH_CODE)
...
FROM GLTB_gL_BAL G WHERE FIN_YEAR||PERIOD_CODE = (SELECT CURRENT_CYCLE||CURRENT_PERIOD
FROM STTM_BRANCH WHERE BRANCH_CODE = G.BRANCH_CODE)
