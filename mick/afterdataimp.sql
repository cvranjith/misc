...
PROMPT
ACCEPT WORK_AREA CHAR PROMPT          'Enter WORK AREA ==>            '
PROMPT
ACCEPT HANDOFF_AREA CHAR PROMPT       'Enter HANDOFF AREA ==>         '
PROMPT
ACCEPT BACKUP_AREA CHAR PROMPT        'Enter BACKUP AREA ==>          '
PROMPT
...
UPDATE	BKTB_SCHEMA_DEFAULTS
SET	NODE = REPLACE(LOWER('&&HOST_NAME'),'.world',''),
	SCHEMA_NAME = '&&FLEXCUBE_USERNAME',
	SPOOL_PATH = '&&BACKUP_AREA'
/
...
SET TRIMSPOOL ON PAGES 0 LINE 999 FEED OFF VERIFY OFF
SPOOL TMP.TMP
REM
SPOOL OFF
